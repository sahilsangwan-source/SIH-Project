        ...
        <div className="container-fluid">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-start">
              ...
              <button type="button" className="btn btn-success" style={{width:"100px",height:"50px",fontSize:"1.2rem"}}>Login</button>
              <button type="button" className="btn btn-success" style={{width:"100px",height:"50px",fontSize:"1.2rem"}}>Sign Up</button>
              </div>
            </div>
